...
@version_router.get("/{id}/history/{version_id}", response_model=EventVersionSchema)
...
@version_router.post("/{id}/rollback/{version_id}", response_model=EventVersionSchema)
