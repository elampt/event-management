...
@collaboration_router.post("/{id}/share", response_model=list[PermissionResponse])
...
@collaboration_router.get("/{id}/permissions", response_model=list[PermissionResponse])
...
@collaboration_router.put("/{id}/permissions/{user_id}", response_model=PermissionResponse)
