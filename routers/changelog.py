...
@changelog_router.get("/{id}/changelog", response_model=List[EventChangelogSchema])
...
@changelog_router.get("/{id}/diff/{version_id1}/{version_id2}", response_model=EventDiffResponse)
